...
<Link href="/#features">Features</Link><Link href="/#how-it-works">How it works</Link><Link href="/#difference">Why CreditPilot</Link><Link href="/#pricing">Beta access</Link><Link href="/terms">Terms</Link>
    </nav>
