...
export function RegisterForm() {
  return <form action={registerAction} className="mt-7 space-y-4">
    ...
    <label className="block text-sm font-medium text-slate-700">Business country<select name="country" defaultValue="GB" className="mt-1.5 w-full rounded-lg border bg-white px-3 py-3 outline-none focus:border-electric focus:ring-2 focus:ring-blue-100"><option value="GB">United Kingdom — GBP</option><option value="IE">Ireland — EUR</option></select><span className="mt-1.5 block text-xs leading-5 text-slate-500">CreditPilot AI is currently available to UK and Irish businesses.</span></label>
