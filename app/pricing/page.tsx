...
export default async function PricingPage({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  const trialEndsAt = new Date(user.company.createdAt.getTime() + 14 * 24 * 60 * 60 * 1000);
