      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mx-auto max-w-7xl p-5 sm:p-8">
          ...
          <section id="add-ons" className="scroll-mt-24 py-14">
            <div className="relative overflow-hidden rounded-[2rem] border border-blue-200/80 bg-gradient-to-br from-white via-blue-50 to-violet-100/70 p-5 text-ink shadow-xl shadow-blue-200/35 sm:p-7">
              ...
              <div className="relative mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">{premiumAddOns.map((addOn, index) => {
                ...
                return <article key={addOn.name} tabIndex={0} aria-label={`${addOn.name}. Hover or focus to view details.`} className="group h-[205px] cursor-pointer rounded-2xl outline-none [perspective:1200px]">
                  <div className="relative h-full w-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] group-focus:[transform:rotateY(180deg)] group-focus-within:[transform:rotateY(180deg)]">
                    <div className="absolute inset-0 flex flex-col overflow-hidden rounded-2xl border border-white/90 bg-white/80 p-5 shadow-md backdrop-blur [backface-visibility:hidden] [-webkit-backface-visibility:hidden] group-hover:pointer-events-none group-focus:pointer-events-none group-focus-within:pointer-events-none">
                    ...
                    <div className={`pointer-events-none absolute inset-0 flex flex-col justify-between rounded-2xl bg-gradient-to-br p-5 text-white shadow-xl [backface-visibility:hidden] [-webkit-backface-visibility:hidden] [transform:rotateY(180deg)] group-hover:pointer-events-auto group-focus:pointer-events-auto group-focus-within:pointer-events-auto ${back}`}>
