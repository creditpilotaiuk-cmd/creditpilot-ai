...
const clauses = [
  ...
  { id: "plans", icon: CreditCard, title: "8. Memberships, payment and cancellation", summary: "Rolling monthly membership with clear payment terms", text: "Founding Beta access is free and will not convert to a paid membership automatically. Paid memberships are rolling monthly subscriptions with no minimum term. Before you buy, we will show the selected membership, monthly price, applicable taxes where relevant, billing date and how to cancel. Stripe processes payment and provides the purchase confirmation and receipt or invoice. A paid membership renews monthly unless you cancel. You may cancel at any time; cancellation takes effect at the end of the current paid billing period. If a payment fails, we will notify you and allow a seven-calendar-day grace period from the payment due date. If payment remains unpaid after that period, we may suspend access until payment is received. No refund is due for an unused part of a paid billing period unless required by law.", colour: "bg-violet-100 text-violet-700" },
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#07183f] via-[#123d91] to-[#2867f0] px-5 py-14 text-white sm:px-8 sm:py-20">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-9 lg:grid-cols-[1.15fr_.85fr] lg:items-center">
        <div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3"><p className="text-sm font-semibold text-blue-200">Last updated: 8 September 2026</p><a href="/creditpilot-ai-terms-and-conditions.pdf" download className="inline-flex items-center gap-2 rounded-lg border border-white/25 bg-white/10 px-3 py-2 text-xs font-bold text-white transition hover:bg-white/20"><Download size={15} />Download PDF</a></div>
