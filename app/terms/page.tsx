...
const clauses = [
  { id: "service", icon: Wrench, title: "1. The service", summary: "What CreditPilot AI does—and does not do", text: "CreditPilot AI organises imported invoice data, priorities, recommended actions, reminders, promises, disputes and collection history. It is not accounting software, a credit-reference agency, debt collection agency or legal adviser, and does not guarantee payment.", colour: "bg-blue-100 text-blue-700" },
  { id: "human-control", icon: Bot, title: "2. Human control and AI", summary: "AI supports decisions; people remain responsible", text: "AI-assisted output may be inaccurate or incomplete. You must review every recommendation and communication before relying on or sending it. CreditPilot AI does not independently decide whether to grant credit, enforce a debt or begin legal action.", colour: "bg-violet-100 text-violet-700" },
  ...
  { id: "beta", icon: Sparkles, title: "7. Beta, integrations and availability", summary: "Features may change while the service develops", text: "Features may change during beta. CreditPilot AI does not submit VAT returns, provide bookkeeping services or replace HMRC-compatible accounting software. Invoice data is currently imported into CreditPilot AI. Direct integrations with Xero, QuickBooks and Sage are planned features and do not currently exist. Customers remain responsible for maintaining accurate financial records in their accounting software and completing applicable accounting, tax and regulatory submissions. The service is provided as available and may be suspended for maintenance, security or provider disruption.", colour: "bg-blue-100 text-blue-700" },
  { id: "plans", icon: CreditCard, title: "8. Memberships, payment, cooling-off and cancellation", summary: "Different protections for business and consumer customers", text: "Founding Beta access is free and will not convert to a paid membership automatically. Paid memberships are rolling monthly subscriptions with no minimum term. Before you buy, we will show the selected membership, monthly price, applicable taxes where relevant, billing date and how to cancel. Stripe processes payment and provides the purchase confirmation and receipt or invoice. Ireland: while our VAT treatment for consumer sales is being finalised, Irish memberships are available only to customers buying mainly for their trade, business, craft or profession. Irish membership prices are shown and charged in EUR, excluding applicable VAT. United States: while sales-tax treatment for consumer sales is being finalised, US memberships are available only to customers buying mainly for their trade, business, craft or profession. US membership prices are shown and charged in USD, excluding applicable sales taxes. Business customers: you may cancel at any time and your membership ends at the end of the current paid billing period. A statutory 14-day cooling-off right does not normally apply to a business buying for its trade, business, craft or profession. Consumers: if you buy as an individual mainly outside your trade, business, craft or profession, you may have a statutory 14-day cooling-off right from the date the contract is made, unless a legal exception applies. If you ask us to start supplying the service during that period, you may have to pay a proportionate amount for the service supplied before you cancel. Where the law allows a cooling-off right for digital content to be lost, we will only rely on that after obtaining your express consent and acknowledgement. A paid membership renews monthly unless you cancel. If a payment fails, we will notify you and allow a seven-calendar-day grace period from the payment due date. If payment remains unpaid after that period, we may suspend access until payment is received. We will provide any refund required by law; otherwise no refund is due for an unused part of a paid billing period.", colour: "bg-violet-100 text-violet-700" },
  { id: "liability", icon: ShieldCheck, title: "9. Liability", summary: "Clear limits on CreditPilot AI’s responsibility", text: "Nothing in these terms excludes or limits liability for fraud, fraudulent misrepresentation, death or personal injury caused by negligence, or any other liability that cannot legally be excluded or limited. Subject to that, CreditPilot AI is responsible only for direct loss that is reasonably foreseeable and caused by its breach of these terms. CreditPilot AI is not responsible for indirect or consequential loss, lost profit, lost revenue, loss of business opportunity, customer non-payment, loss caused by inaccurate or incomplete data, or decisions made from unverified data or AI-assisted output. You remain responsible for reviewing communications and decisions before relying on them.", colour: "bg-amber-100 text-amber-700" },
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#07183f] via-[#123d91] to-[#2867f0] px-5 py-14 text-white sm:px-8 sm:py-20">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-9 lg:grid-cols-[1.15fr_.85fr] lg:items-center">
        <div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3"><p className="text-sm font-semibold text-blue-200">Last updated: 20 September 2026</p><a href="/creditpilot-ai-terms-and-conditions-2026-09-20.pdf" download className="inline-flex items-center gap-2 rounded-lg border border-white/25 bg-white/10 px-3 py-2 text-xs font-bold text-white transition hover:bg-white/20"><Download size={15} />Download PDF</a></div>
