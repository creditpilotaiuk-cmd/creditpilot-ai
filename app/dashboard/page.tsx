...
export default async function DashboardPage() {
  ...
  return <main className="flex min-h-screen"><DashboardSidebar /><div className="min-w-0 flex-1"><header className="border-b bg-white px-5 py-4 sm:px-8"><p className="text-sm text-slate-500">Credit control workspace · {user.company.name}</p><h1 className="text-xl font-bold text-ink">Good morning, {firstName}</h1></header><div className="mx-auto max-w-7xl p-5 sm:p-8">
